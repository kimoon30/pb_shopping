export default function CTA() {
  ...
  return (
    <section id="cta" className="relative bg-[#F8F8F8] overflow-hidden flex justify-center">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 top-[203px] bg-white rounded-[24px] p-[20px]">
            <div className="bg-white rounded-[40px] px-[40px] flex flex-row justify-center items-center h-[175px] gap-[24px]">
              ...
              <div className="flex flex-col justify-center items-center gap-[12px]">
                <a
                  href="https://pass.sktelecom.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-row justify-center items-center gap-[4px] px-[40px] py-[20px] bg-white border border-black rounded-[16px] hover:bg-gray-50 transition-colors w-[245px]"
                >
                  <span className="text-[20px] font-semibold text-[#333333] tracking-[0] text-center leading-[1em]">페이백쇼핑 바로가기</span>
                </a>
              </div>
            </div>
          </div>
      ...
      {/* 모바일/태블릿 레이아웃 */}
      <div className="lg:hidden w-full px-4 sm:px-8 md:px-16 py-12 md:py-16">
            ...
            <div className="bg-white rounded-[30px] px-6 py-8 flex flex-col items-center gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 px-6 py-3 bg-white border border-black rounded-[12px] hover:bg-gray-50 transition-colors flex-1"
                >
                  <span className="text-[16px] md:text-[18px] font-semibold text-[#333333]">페이백쇼핑 바로가기</span>
                </a>
              </div>
            </div>
          </div>
