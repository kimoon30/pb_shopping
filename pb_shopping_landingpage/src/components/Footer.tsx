export default function Footer() {
  return (
    <footer id="footer" className="bg-[#F2F2F2] py-8 md:py-10 lg:py-[34px] border-t border-[#E0E0E0] flex justify-center">
      <div className="mx-auto px-4 sm:px-8 md:px-16 lg:px-[320px] w-full max-w-[1920px] flex flex-col lg:flex-row justify-between gap-8 lg:gap-0">
        {/* 왼쪽: 회사 정보 */}
        ...
        {/* 오른쪽: 연락처 및 링크 */}
        <div className="flex flex-col justify-between lg:items-end gap-4 md:gap-5 lg:gap-[20px] h-[146px]">
          ...
          <div className="flex items-center gap-3 md:gap-4 lg:gap-[13px]">
            <button className="text-[13px] md:text-[14px] font-normal text-[#757575] hover:text-[#222222] transition-colors leading-[1.2857em]">
              이용 약관
            </button>
            <button className="text-[13px] md:text-[14px] font-normal text-[#757575] hover:text-[#222222] transition-colors leading-[1.2857em]">
              개인정보 처리방침
