...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="bg-[#F8F8F8] py-12 md:py-20 lg:py-[100px]">
      <div className="mx-auto px-4 sm:px-8 md:px-16 lg:px-[360px]">
        <div className="flex flex-col items-center gap-8 md:gap-12 lg:gap-[60px]">
          <h2 className="text-[28px] sm:text-[35px] md:text-[40px] lg:text-[45px] font-semibold text-[#222222] tracking-[-0.025em] text-center">
            궁금한점 있으신가요?
          </h2>
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <button
                  ...
                  className="w-full p-4 md:p-6 lg:p-10 flex items-center justify-between hover:bg-gray-50 transition-colors"
                >
                  <div className="flex items-center gap-2 md:gap-3 flex-1 min-w-0">
                    ...
                    <span className="text-[14px] sm:text-[16px] md:text-[18px] lg:text-[20px] font-semibold text-[#222222] tracking-[-0.03em] text-left">
                      {faq.question}
                    </span>
                  </div>
                  <div className="flex-shrink-0 ml-2 md:ml-3">
                    <svg
                      ...
                      height="24"
                      viewBox="0 0 28 28"
                      className={`transition-transform w-5 h-5 md:w-6 md:h-6 lg:w-7 lg:h-7 ${openIndex === index ? 'rotate-180' : ''}`}
                      fill="none"
                    >
                      <path
                ...
                {openIndex === index && (
                  <>
                    <div className="w-full h-px bg-[#E4E4E4] mx-4 md:mx-6 lg:mx-10"></div>
                    <div className="p-4 md:p-6 lg:p-10 flex items-start gap-2 md:gap-3">
                      ...
                      <p className="text-[14px] md:text-[16px] lg:text-[18px] font-normal text-[#222222] tracking-[-0.025em] leading-[1.5em]">
                        {faq.answer}
                      </p>
                    </div>
                  </>
