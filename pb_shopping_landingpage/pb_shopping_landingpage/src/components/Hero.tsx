...
export default function Hero() {
  return (
    <section id="hero" className="relative w-full min-h-[750px] sm:min-h-[800px] md:min-h-[900px] lg:min-h-[1080px] bg-gradient-to-b from-white to-[#FFF0D3] overflow-hidden flex justify-center">
        ...
        <div className="text-center mb-8 max-w-[600px] mx-auto">
          ...
          <div className="flex justify-center mb-6">
            <div className="relative inline-flex items-center">
              <div className="bg-white rounded-full shadow-[0_0_8px_rgba(0,0,0,0.1)] px-3 sm:px-[15px] py-[6px]">
                <span className="text-[13px] sm:text-[15px] font-extrabold text-[#FF2D2D] tracking-[-0.025em] leading-[23px]">
                  Beta 프로모션 진행중!
                </span>
              </div>
              <svg 
                className="absolute -right-[10px] sm:-right-[13px] top-1/2 -translate-y-1/2" 
                width="18" 
                height="14" 
                viewBox="0 0 20 16" 
                fill="none"
          ...
          <div className="flex items-center justify-center gap-2 mb-4 flex-wrap">
            <div className="px-2 py-1 bg-[#222222] rounded text-[11px] sm:text-[12px] font-semibold text-white tracking-[-0.025em]">
              가입자수 1,400만 +
            </div>
            <div className="px-2 py-1 bg-[#222222] rounded text-[11px] sm:text-[12px] font-semibold text-white tracking-[-0.025em]">
              MAU 700만 +
          ...
          <h2 className="text-[14px] sm:text-[16px] md:text-[18px] font-semibold text-[#222222] tracking-[-0.025em] mb-4">
            SKT PASS와 함께하는 매출 보장형 광고상품
          </h2>

          <h1 className="text-[40px] sm:text-[48px] md:text-[60px] font-extrabold text-[#FF3A4A] tracking-[-0.03em] leading-[1.5em] mb-4">
            페이백쇼핑
          </h1>

          <p className="text-[14px] sm:text-[16px] md:text-[18px] font-normal text-[#463636] tracking-[-0.025em] mb-6">
            압도적인 트래픽과 실구매·리뷰의 힘으로<br />
            매출 부스팅을 경험하세요!
          </p>

          {/* 모바일 일러스트레이션 */}
          <div className="relative w-full max-w-[350px] sm:max-w-[400px] mx-auto mb-8">
            <img
              src="/images/hero-main-illustration.png"
              alt="페이백쇼핑 일러스트"
