...
export default function ContactForm() {
  ...
  return (
    <>
      ...
      <div id="contact-form" className="w-full max-w-[568px] bg-white rounded-[20px] shadow-[0_0_20px_rgba(213,196,162,0.1)] p-4 sm:p-6 md:p-8 lg:p-10">
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 md:gap-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
          ...
          <a 
            href="https://www.saveshopping.kr/terms/id/54"
            target="_blank"
            rel="noopener noreferrer"
            className="text-[12px] sm:text-[13px] md:text-[14px] font-light text-[#808080] tracking-[-0.03em] underline self-start sm:self-auto hover:text-[#222222] transition-colors"
          >
          약관
          </a>
          </div>
        ...
        <div className="flex flex-col gap-2">
          <button
            type="submit"
            disabled={!agreed}
            className={`w-full py-3 sm:py-4 md:py-5 rounded-xl text-[13px] sm:text-[14px] md:text-[16px] font-semibold text-white tracking-[-0.025em] transition-all leading-[1.4em] ${
              agreed
                ? 'bg-[#FF3A4A] hover:bg-[#E63342]'
                : 'bg-gray-300 cursor-not-allowed'
            }`}
          >
            <span className="block sm:inline">상담 신청하기</span>
            <span className="hidden sm:inline"><br /></span>
            <span className="sm:hidden"> </span>
            <span className="block sm:inline">[무료 프로모션 혜택 받기]</span>
          </button>
          <p className="text-center text-[11px] sm:text-[12px] md:text-[14px] font-light text-[#808080] tracking-[-0.025em]">
